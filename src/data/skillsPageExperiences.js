...
let skills = {
	...
	CSS: [
		...
		"Creating responsive web pages with ease.",
	...
	React: ["My prefered way of writing JavaScript.", "Use it to create Single Page Applications with ease."],
	PHP: [
		"Learned it in 2012.",
		"Used it mainly to connect Pages with SQL Databases, and to create interactive web pages before I learned JavaScript.",
	],
