...
const projectsData = [
	{
		...
		imgDesc: [
			...
			"Page is component based and sections are added to the page as the user scrolls in.",
			"Page footer with links to social networks and other useful information.",
	...
	},
	{
		...
		imgDesc: [
			"A landing page for digital music store. Contains links to other pages. Single-page application",
			...
			"Cart page, user can add more of the same items and can remove the items. Page displays price and a purchase button. Also, page saves users' selected items in local storage.",
			"Page is responsive for different screen sizes.",
			"Page is responsive for different screen sizes.",
			"Page is responsive for different screen sizes.",
			"Page is responsive for different screen sizes.",
	...
	},
	{
		...
		imgDesc: [
			"Component which alows user to change the theme of the page.",
			"Component which alows user to change the theme of the page.",
			"Component which alows user to change the theme of the page.",
		],
	...
	},
	{
		...
		imgDesc: [
			...
			"Game page, user gets one randomly selected pokemon and has to click on it. Game keeps track of combo (current score) and high-score (the highest of all combos).",
			"Game page, user gets one randomly selected pokemon and has to click on it. Game keeps track of combo (current score) and high-score (the highest of all combos).",
		],
		name: "Pokemon App",
	...
	},
	{
		...
		imgDesc: [
			"A landing page for my personal portfolio page, contains links for downloading CV.",
			"Skills page which displays my skills with different web development tools and languages.",
			"Projects page which shows my finished projects. User can filter them or open specific project which they are interested in.",
			"Modal for showing selected project's images. Image also shows different page theme.",
			"About page which serves as my CV. Image also shows a different page theme",
	...
	},
	{
		...
		imgDesc: [
			...
			"User clicks on one of the options and the computer randomly generates a response.",
	...
	},
	{
		id: 11,
		img: [toDo1, toDo2],
		imgDesc: ["User can add new to-do's.", "User can mark and unmark individual list items and finished."],
		name: "To-Do List",
	...
	},
	{
		...
		imgDesc: [
			"A landing page for Yu-Gi-Oh card search page. Contains links to other pages.",
			"Search page, contains a list of all Yu-Gi-Oh cards and Search form. User can add cards to the cart.",
			"User can filter cards.",
			"Cards are color coded to represent their real life type (Monsters, Spells, Traps...). ",
			"Cart page, displays selected cards. User can add more of the same cards or remove them. Also displays a total price.",
			"Page is responsive for different screen sizes.",
			"Page is responsive for different screen sizes.",
			"Page is responsive for different screen sizes.",
			"Page is responsive for different screen sizes.",
